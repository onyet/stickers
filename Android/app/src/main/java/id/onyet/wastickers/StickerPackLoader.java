...
import static id.onyet.wastickers.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static id.onyet.wastickers.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static id.onyet.wastickers.StickerContentProvider.PUBLISHER_EMAIL;
import static id.onyet.wastickers.StickerContentProvider.PUBLISHER_WEBSITE;
import static id.onyet.wastickers.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static id.onyet.wastickers.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
